...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        # bump sound
        self.sound = pygame.mixer.Sound("Bump.wav")
        self.sound.set_volume(.03)
...
for i in range(50):
    ...
    block_sound = pygame.mixer.Sound("Pop.wav")
    block_sound.set_volume(.03)
...
for i in range(50):
    ...
    block1_sound = pygame.mixer.Sound("bad.wav")
    block1_sound.set_volume(.03)
