...
while not done:
    ...
    # Cloud 1
    pygame.draw.ellipse(screen, PURPLE, [50, 100, 100, 50])
    pygame.draw.ellipse(screen, PURPLE, [80, 125, 100, 50])
    pygame.draw.ellipse(screen, PURPLE, [100, 80, 100, 50])
    pygame.draw.ellipse(screen, PURPLE, [125, 115, 120, 50])

    # Cloud 2
    pygame.draw.ellipse(screen, PURPLE, [600, 215, 150, 50])
    pygame.draw.ellipse(screen, PURPLE, [555, 225, 100, 50])
    pygame.draw.ellipse(screen, PURPLE, [575, 180, 100, 50])
    pygame.draw.ellipse(screen, PURPLE, [515, 200, 150, 50])
    ...
    # Boat
    pygame.draw.ellipse(screen, DARK_BLUE, [550, 385, 70, 20])
    pygame.draw.ellipse(screen, BROWN, [550, 345, 80, 50])
    pygame.draw.rect(screen, YELLOW, [550, 345, 700, 20])
    pygame.draw.polygon(screen, OFF_WHITE, ([588, 320], [560, 350], [620, 350]))
    pygame.draw.line(screen, DARK_BROWN, [588, 365], [588, 320], 3)
