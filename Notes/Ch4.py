...
print(random.randrange(10))  # generates a random int from 0 - 9
print(random.randrange(5, 10))  # generates a random int from 5 - 9
...
# Add all the number from 1 to 100
total = 0
...
# what are all of the squared numbers under 100,000?
'''
n = 1
while n ** 2 <= 100000:
    print(n, "squared is", ** 2)
    n += 1
'''
